package com.code4a.jlibrary.loading.render;

import android.content.Context;
import android.util.SparseArray;

import com.code4a.jlibrary.loading.render.animal.FishLoadingRenderer;
import com.code4a.jlibrary.loading.render.animal.GhostsEyeLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.jump.CollisionLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.jump.DanceLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.jump.GuardLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.jump.SwapLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.rotate.GearLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.rotate.LevelLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.rotate.MaterialLoadingRenderer;
import com.code4a.jlibrary.loading.render.circle.rotate.WhorlLoadingRenderer;
import com.code4a.jlibrary.loading.render.goods.BalloonLoadingRenderer;
import com.code4a.jlibrary.loading.render.goods.WaterBottleLoadingRenderer;
import com.code4a.jlibrary.loading.render.scenery.DayNightLoadingRenderer;
import com.code4a.jlibrary.loading.render.scenery.ElectricFanLoadingRenderer;
import com.code4a.jlibrary.loading.render.shapechange.CircleBroodLoadingRenderer;
import com.code4a.jlibrary.loading.render.shapechange.CoolWaitLoadingRenderer;
