package com.code4a.jlibrarydemo.widget;
...
/**
 * Created by code4a on 2016/9/28.
 */
...
public class ViewPagerIndicator extends LinearLayout {
    ...
    private void init() {
        LogUtil.m();
        this.setBackgroundDrawable(getResources().getDrawable(R.drawable.home_bg));
        paint = new Paint();
        ...
        if (getChildCount() > 0) {
            for (int i = 0; i < getChildCount(); i++) {
                if (i == currentPosition) {
                    ...
                    ((TextView) getChildAt(i)).setTextColor(getResources().getColor(R.color.font_bar_color));
                }
            }
        }
    }
